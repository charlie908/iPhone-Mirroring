...
Once the server is running at `127.0.0.1:12005`, make your first call:

```bash
curl -X POST http://127.0.0.1:12005/rpc \
...
DeviceKit runs as an XCUITest. Once installed and launched on a device or simulator, it starts a server on `127.0.0.1:12005`.

### Environment Variables

| Variable | Default | Description |
|----------|---------|-------------|
| `DEVICEKIT_LISTEN_PORT` | `12005` | JSON-RPC server port |
